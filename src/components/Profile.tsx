                ...
                <div className="row">
                    ...
                    <div className="profile-card col-lg-3">
                        <div className="profile-content">
                            ...
                            <NavLink className="edit-profile" to="/edit-profile">Edit Profile</NavLink>
                        </div>
                    </div>
                    ...
                    <div className="feed col-lg-6">
                        ...
                        <form className='nav-search--form' action="GET">
                            <input type="text" name="q" placeholder="Search user's posts..." />
                        </form>
                        {/* Post count */}
                        ...
                        <div className="post-card">
                            ...
                            <div className="post-card-footer">
                                ...
                                <NavLink to="/post/1" className="participants">
                                    {/* {
                                        post.commented ? */}
